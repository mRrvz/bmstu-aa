...
На рисунке 2.5 представленна схема с параллельным выполнением первого цикла (по строкам матрицы), а на рисунке 2.6 -- с параллельнлым выполнением второго цикла (по столбам матрицы.)
