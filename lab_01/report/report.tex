...
\begin{titlepage}
	...
	\begin{center}
		\noindent\begin{minipage}{1.3\textwidth}\centering
			\Large\textbf{  Отчет по лабораторной работа №1}\newline
...
\begin{enumerate}
	\item Изучение метода динамического программирования на материале алгоритмов поиска расстояния Левенштейна и Дамерау-Левенштейна.
...
\addlegendentry{L: Iterative}
\addlegendentry{DL: Iterative}
\addlegendentry{L: Recursive}
\addlegendentry{L: RecursiveMemoized}
\end{axis}
\end{tikzpicture}
